...
const BottomEditPanel = forwardRef<BottomEditPanelRef, BottomEditPanelProps>(
  ({ node, allNodes, onUpdate, onClose, onDeleteChoice, globalVariables = [], storyMeta, onDraftChange }, ref) => {
  ...
  useImperativeHandle(ref, () => ({
    ...
    const handleDraftChange = useCallback(() => {
      ...
      if (mergedData) onUpdate(node.id, mergedData);
      onDraftChange?.();
    }, [getMergedData, node.id, onDraftChange, onUpdate]);
