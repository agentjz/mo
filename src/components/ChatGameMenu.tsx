...
function ChatGameMenu({ playerController, onClose, onNewGame, onExit }: ChatGameMenuProps): JSX.Element {
        ...
        {visitedNodes.length > 0 && (
          <div className="chat-game-menu-node-list">
            {visitedNodes.map(node => (
              ...
              >
                <div className="chat-game-menu-node-name">{node.sceneName}</div>
  ...
  return (
    <div className="chat-game-menu-overlay">
      <div className="chat-game-menu" role="dialog" aria-modal="true" aria-label="游戏菜单">
